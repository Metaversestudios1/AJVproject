      ...
      >
        ...
        <div className="relative font-[sans-serif] w-max mx-10">
          ...
          {openNotification && (
            ...
            <button type="button" onClick={handleOpenNotification} className=" bg-white rounded-md p-2 m-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
